...
var (
	ErrInvalidBlack     = sdkerrors.Register(ModuleName, 2200, "black address is invalid: %s")
	ErrInvalidRed       = sdkerrors.Register(ModuleName, 2201, "red address is invalid: %s")
	ErrGameNotParseable = sdkerrors.Register(ModuleName, 2202, "game cannot be parsed")
)
